...
/// Admin console landing screen.
///
/// Shows the segregated Shop Afrik platform account as three buckets **per
/// currency**: held in escrow, owed to sellers, and earned commission.
/// Currencies are never blended into a single figure, and only commission is
/// labeled as revenue — escrow and payable are liabilities.
